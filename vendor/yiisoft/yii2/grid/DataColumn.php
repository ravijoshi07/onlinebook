...
class DataColumn extends Column
{
    ...
    protected function renderFilterCellContent()
    {
        ...
        // Jaya Parwani : Patch Put to show placeholder in grid view
        if(!empty($model->attributeLabels()[$this->attribute])){
            $this->filterInputOptions['placeholder']    =   $model->attributeLabels()[$this->attribute];
        } else {
            $this->filterInputOptions['placeholder']    =   ucwords(implode(' ',explode('_',$this->attribute)));
        }
