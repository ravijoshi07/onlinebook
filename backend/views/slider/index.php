                                    ...
                                    echo GridView::widget([        
                                        ...
                                        'columns' => [
                                            ...
                                            [   
                                                         ...
                                                         'format'=>'raw',
                                                         'value' => function($data){
                                                            //prd($data->getAttributeLabel('image'));
                                                             $url = \Yii::$app->request->BaseUrl.'/uploads/banner/'.$data->image;
...
<script type="text/javascript">
    function submitUserForm(userId){
        ...
        var url = "<?php echo Yii::$app->urlManager->createUrl('slider/update?id='); ?>"+userId;
                
        if(parseInt(userId)==0){
            var url = "<?php echo Yii::$app->urlManager->createUrl('slider/create'); ?>";
